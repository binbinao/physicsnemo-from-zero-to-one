...
![F4.0 Airfoil flow banner](../book/assets/f4_0_banner.png)
...
![F4.1 Framework switch diagram](../book/assets/f4_1_framework_switch.png)
...
![F4.2 FNO quick start prediction results](../book/assets/f4_2_fno_prediction.png)
...
![F4.3 PINN vs FNO multi-condition comparison](../book/assets/f4_3_pinn_vs_fno.png)
...
![F4.4 Neural operator function-to-function mapping diagram](../book/assets/f4_4_neural_operator.png)
...
![F4.5 FNO block: FFT → spectral conv → iFFT](../book/assets/f4_5_fno_block.png)
...
![F4.6 AirfRANS data preprocessing pipeline](../book/assets/f4_6_data_pipeline.png)
...
![F4.7 Pressure field prediction vs ground truth](../book/assets/f4_7_pressure_field.png)
...
![F4.8 Cp curve comparison](../book/assets/f4_8_cp_curve.png)
...
![F4.9 FNO tuning triple plot](../book/assets/f4_9_tuning.png)
