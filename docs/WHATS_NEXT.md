...
| 资源 | 说明 |
|:---|:---|
| [START_HERE_CAE.md](START_HERE_CAE.md) | 签审工作流导读 |
| [VV_REPORT_TEMPLATE.md](VV_REPORT_TEMPLATE.md) | 代理模型验收报告 |
| ASME V&V 40 | 仿真可信度标准（订阅/购买） |
| [NAFEMS](https://www.nafems.org/) | 仿真社区与 AI/ML 研讨 |
